const teamOptions = [
  {
    ...
    key: 19,
    display_name: 'Charlotte Bobcats',
    short_name: 'CHA'
  }, {
    key: 20,
    ...
    key: 30,
    display_name: 'West All Star',
    short_name: 'WEST'
  }, {
    key: 31,
    display_name: 'East All Star',
    short_name: 'EAST'
  }
];
...
const roundtypeOptions = [
  {
    key: 0,
    display_name: 'pointdiff'
  }, {
    key: 1,
    display_name: 'winlose'
  }, {
    key: 2,
    display_name: 'range'
  }
...
export function playerJoinStatus(playerRoundBets, round) {
  switch (round.status) {
    ...
    case 2: // publing
      return {index: 2, value: 'Opening'};
    case 3: // drawing
      return {index: 3, value: 'Drawing'};
    case 4: // returning
      return {index: 4, value: 'Returning'};
    default:
      return {index: 5, value: 'Finished'};
  }
};
